package com.github.PiotrDuma.imageshack.tools.token.TokenAuthDomain;
...
//  @Autowired
//  public TokenAuthFacadeImpl(com.github.PiotrDuma.imageshack.tools.token.TokenAuthDomain.TokenAuthService service, EmailValidator emailValidator) {
//    this.service = service;
//    this.emailValidator = emailValidator;
//  }
//
//  @Override
//  public TokenObject create(TokenRequest tokenObject) {
...
//  }
//
//  private static void checkInput(@NotNull TokenRequest token){
